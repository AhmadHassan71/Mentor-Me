...
data class User(val userId:String,val email: String, var fullName: String? = null, val city: String, val country: String, var profilePic: String, var bannerPic: String,var fcmToken: String? = null){
    constructor() : this("","","","","","","","")
